  ...
  private providerGroups: NavGroup[] = [
    {
      items: [
        ...
        { path: '/provider/appels', label: 'Appels à candidature', icon: 'campaign' },
        { path: '/provider/invitations', label: 'Invitations', icon: 'mail_outline' },
  ...
  private enterpriseGroups: NavGroup[] = [
    {
      items: [
        ...
        { path: '/enterprise/teams', label: 'Équipes', icon: 'groups' },
        { path: '/enterprise/appels', label: 'Appels à candidature', icon: 'campaign' },
        ...
        { path: '/enterprise/solicitations/sent', label: 'Sollicitations envoyées', icon: 'send' },
