#!/usr/bin/env python
"""Script pour créer les catégories de missions"""
import os
import sys
import django
...
def create_categories():
    ...
    for cat_data in categories_data:
        ...
        if created:
            count += 1
            print(f"✓ Créé: {cat_data['name']}")
        else:
            print(f"• Existe déjà: {cat_data['name']}")
    
    print(f"\n{count} catégories créées, {Category.objects.count()} total")
