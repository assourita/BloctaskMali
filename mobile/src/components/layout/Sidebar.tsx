...
const PROVIDER_NAV: NavItem[] = [
  ...
  { label: 'Appels à candidature', href: '/appels', match: '/appels' },
  { label: 'Invitations', href: '/invitations', match: '/invitations' },
...
const ENTERPRISE_NAV: NavItem[] = [
  ...
  { label: 'Invitations', href: '/enterprise-invitations', match: '/enterprise-invitations' },
